...
for(i in experiment) # select only the columns with OTU read numbers
{
	for(j in 97:97)
	{
	    ...
	    write.table(curated_result$curated_table, file = paste0("table_300test_lulu_curated_", i, "_", j, ".txt"), sep = "\t")
	    write.table(curated_result$curated_otus, file = paste0("otus_300test_lulu_curated_", i, "_", j, ".txt"), sep = "\t")
